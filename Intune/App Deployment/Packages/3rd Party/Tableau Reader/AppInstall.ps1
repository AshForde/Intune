...
$AppVersion = "24.1.1132"
$Installer = "TableauReader-64bit-2024-1-3.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "ACCEPTEULA=1 DESKTOPSHORTCUT=1 /quiet /norestart" # Optional
